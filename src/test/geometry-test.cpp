...
void test_rs_graphics_geometry_box() {
    ...
    TEST_EQUAL(std::format("{}", b1), "B[0,0]+[0,0]");

    TRY((p = {0, 0}));  TEST((! b1.contains(p)));
    TRY((p = {5, 5}));  TEST((! b1.contains(p)));

    TRY((b1 = Box_i2{Int2(10, 20), Int2(30, 40)}));
    ...
    TEST_EQUAL(std::format("{}", b1), "B[10,20]+[30,40]");
    ...
    TRY((b1 = Box_i2{Int2(40, 80), Int2(-30, -60)}));
    TEST_EQUAL(b1.base().x(), 10);
    TEST_EQUAL(b1.base().y(), 20);
    TEST_EQUAL(b1.apex().x(), 40);
    ...
    TRY(b2 = b1);
    TEST_EQUAL(b1, b2);
    TRY((b2 = Box_i2{Int2(10, 20), Int2(30, 50)}));
    TEST(b1 != b2);

    TRY((b2 = Box_i2{Int2(0, 30), Int2(20, 10)}));   TEST(! b1.contains(b2));
    TRY((b2 = Box_i2{Int2(10, 30), Int2(25, 10)}));  TEST(b1.contains(b2));
    TRY((b2 = Box_i2{Int2(10, 30), Int2(30, 10)}));  TEST(b1.contains(b2));
    TRY((b2 = Box_i2{Int2(10, 30), Int2(35, 10)}));  TEST(! b1.contains(b2));
    TRY((b2 = Box_i2{Int2(30, 30), Int2(10, 10)}));  TEST(b1.contains(b2));
    TRY((b2 = Box_i2{Int2(30, 30), Int2(15, 10)}));  TEST(! b1.contains(b2));
    TRY((b2 = Box_i2{Int2(40, 30), Int2(10, 10)}));  TEST(! b1.contains(b2));

    v = {5, 25};

    TRY(b2 = b1 + v);  TEST_EQUAL(std::format("{}", b2), "B[15,45]+[30,40]");
    TRY(b2 = b2 - v);  TEST_EQUAL(std::format("{}", b2), "B[10,20]+[30,40]");
    ...
    TEST_EQUAL(b1.shape().x(), 30);
    TEST_EQUAL(b1.shape().y(), 40);
    TEST_EQUAL(std::format("{}", b1), "B[-20,20]+[30,40]");
    ...
    TEST_EQUAL(std::format("{}", b1), "B[0,0]+[1,1]");
...
void test_rs_graphics_geometry_sphere() {
    ...
    TEST_EQUAL(std::format("{}", s1), "S[0,0,0]+1");
    TEST_EQUAL(s1.centre(), Double3::null());
    ...
    TRY((s1 = Sphere_d3{{10.0,20.0,30.0}, -5.0}));
    TEST_EQUAL(std::format("{}", s1), "S[10,20,30]+5");
    ...
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{0.0,0.0,0.0}, 1.0}));  TEST(s1.contains(s2));    TEST(! s1.disjoint(s2));
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{1.0,0.0,0.0}, 1.0}));  TEST(s1.contains(s2));    TEST(! s1.disjoint(s2));
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{2.0,0.0,0.0}, 1.0}));  TEST(s1.contains(s2));    TEST(! s1.disjoint(s2));
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{3.0,0.0,0.0}, 1.0}));  TEST(! s1.contains(s2));  TEST(! s1.disjoint(s2));
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{4.0,0.0,0.0}, 1.0}));  TEST(! s1.contains(s2));  TEST(s1.disjoint(s2));
    TRY((s1 = Sphere_d3{{0.0,0.0,0.0}, 3.0})); TRY((s2 = Sphere_d3{{5.0,0.0,0.0}, 1.0}));  TEST(! s1.contains(s2));  TEST(s1.disjoint(s2));

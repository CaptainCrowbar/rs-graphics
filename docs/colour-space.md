...
Types that can be used as colour channels.
...
class CIEXYZ {
    ...
    template <ColourChannel T> static constexpr Vector<T, 3>
...
class CIELab {
    ...
    template <ColourChannel T> static Vector<T, 3>
        from_base(Vector<T, 3> colour) noexcept;
    template <ColourChannel T> static Vector<T, 3>
        to_base(Vector<T, 3> colour) noexcept;
};
...
class Greyscale {
    ...
    static constexpr Csp properties = Csp::linear | Csp::unit;
    template <ColourChannel T> static constexpr Vector<T, 1>
        from_base(Vector<T, 3> colour) noexcept;
    template <ColourChannel T> static constexpr Vector<T, 3>
